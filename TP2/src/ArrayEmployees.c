...
{
	printf("\n//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////");
	printf("\n¿Cómo desea mostrar su lista de Empleados?");
	printf("\n1_ Ascendente");
	printf("\n2_ Descendente");
	printf("\n(Tenga en cuenta, que si tiene empleados con el mismo apellido se tomará como criterio el sector donde se encuentre)");
	printf("\nIngrese su opcion: ");
}
